...
async def setup_hook():
    ...
    for ext in ["cogs.alerts", "cogs.reactions", "cogs.leaderboard", "cogs.attackers", "cogs.attaque", "cogs.pvp"]:
        try:
...
if __name__ == "__main__":
    ...
    try:
        ...
        # 🟪 Nouvelle team RUTHLESS (team_id = 9)
        upsert_team(
            1139550147190214727,
            9,
            "Ruthless",
